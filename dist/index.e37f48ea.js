...
},{"core-js/modules/web.immediate.js":"49tUX","./model.js":"Y4A21","./views/recipeView.js":"l60JC","./views/searchView.js":"9OQAM","./views/resultsView.js":"cSbZE","./views/paginationView.js":"6z7bi","./views/bookmarksView.js":"4Lqzq","./views/addRecipeView.js":"i6DNj","./config.js":"k5Hzs","regenerator-runtime":"dXNgZ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"49tUX":[function(require,module,exports) {
"use strict";
...
const loadRecipe = async function(id) {
    try {
        ...
        const data = await (0, _helperJs.getJSON)(`${(0, _config.API_URL)}${id}?key=${(0, _config.API_KEY)}`);
...
const loadSearchResults = async function(query) {
    try {
        ...
        const data = await (0, _helperJs.getJSON)(`${(0, _config.API_URL)}?search=${query}&key=${(0, _config.API_KEY)}`);
...
const uploadRecipe = async function(newRecipe) {
    try {
        ...
        const data = await (0, _helperJs.sendJSON)(`${(0, _config.API_URL)}?key=${(0, _config.API_KEY)}`, recipe);
...
},{"./config":"k5Hzs","regenerator-runtime":"dXNgZ","./helper.js":"lVRAz","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"k5Hzs":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const API_KEY = "2ea74c63-c5c8-485b-9297-04b6b4201f41";
const MODAL_CLOSE_SEC = 0.8;
...
class RecipeView extends (0, _viewDefault.default) {
    ...
    _errorMessage = "Sorry, we couldn`t find your recipe! \uD83E\uDDD0";
    _message = "";
    addHandlerUpdateServings(handler) {
        this._parentElement.addEventListener("click", function(e) {
            const btn = e.target.closest(".btn--update-servings");
            //if button element is not selected do nothing
            if (!btn) return;
            const newServing = Number(btn.dataset.update);
            if (newServing < 1 || newServing > 10) return;
            handler(newServing);
        });
    }
        ...
        <div class="recipe__details">
          <div class="recipe__info">
            <svg class="recipe__info-icon">
              <use href=${this._data.imageUrl}></use>
            </svg>
...
class PaginationView extends (0, _viewDefault.default) {
    ...
    _generateMarkup() {
        ...
        if (currPage === 1 && numPages > 1) return this._generateMarkupNextPage(currPage);
        //last page
        if (currPage === numPages && numPages > 1) return this._generateMarkupPrevPage(currPage);
        //other page
...
},{"./View":"5cUXS","url:../../img/icons.svg":"loVOp","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["hycaY","aenu9"], "aenu9", "parcelRequirebf60")
